            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between" style="align-items: center;">
                        ...
                        <div>
                            <a href="{{ route('teacher.create') }}" class="btn btn-warning waves-effect waves-light m-1">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <a type="button" href="{{ route('teacher.show',$item->id) }}" class="btn btn-light waves-effect waves-light m-1">
                                                    <i class="fa fa-eye"></i> <span>view</span>
                                                </a>
                                                @if (Auth::user()->role_id == 1)
                                                <a type="button" href="{{ route('teacher.edit',$item->id) }}" class="btn btn-warning waves-effect waves-light m-1">
