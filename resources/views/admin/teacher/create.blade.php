            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr />
                        <form method="POST" action="{{ route('teacher.store') }}" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="first_name" value="{{ old('first_name') }}" class="form-control" id="input-21" placeholder="First name" />
                                    @error('first_name')
                                    <div class="text-warning">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="last_name" value="{{ old('last_name') }}" class="form-control" id="input-21" placeholder="Last name" />
                                    @error('last_name')
                                    <div class="text-warning">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" name="email" value="{{ old('email') }}" class="form-control" autocomplete="off" id="input-22" placeholder="Enter Your Email Address" />
                                    @error('email')
                                    <div class="text-warning">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="phone" value="{{ old('phone') }}" class="form-control" id="input-23" placeholder="phone" />
                                    @error('phone')
                                    <div class="text-warning">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="money" value="{{ old('money') }}" class="form-control" id="input-23" placeholder="phone" />
                                    @error('money')
                                    <div class="text-warning">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="teaches" class="form-control">
                                        ...
                                        <option {{ old('teaches') == $key ? "selected" : "" }} value="{{$key}}">{{$value}}</option>
                                        @endforeach
                                    </select>
                                    @error('teaches')
                                    <div class="text-warning">{{ $message }}</div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="speakes" id="" class="form-control">
                                        @foreach(countries() as $key => $value)
                                        <option {{ old('speakes') == $key ? "selected" : "" }} value="{{ $key }}">{{$value}}</option>
                                        @endforeach
                                    </select>
                                    @error('speakes')
                                    <div class="text-warning">{{ $message }}</div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="teacher_from" class="form-control">
                                        @foreach(countries() as $key => $value)
                                        <option {{ old('teacher_from') == $key ? "selected" : "" }} value="{{$key}}">{{$value}}</option>
                                        @endforeach
                                    </select>
                                    @error('teacher_from')
                                    <div class="text-warning">{{ $message }}</div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="teaching_style" class="form-control" cols="30" rows="10"></textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="teaching_material" class="form-control" cols="30" rows="10"></textarea>
