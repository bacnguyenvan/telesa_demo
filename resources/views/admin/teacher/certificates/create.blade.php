            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr />
                        <form method="POST" action="{{ route('certificates.store') }}" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <textarea name="description" id="description" style="width: 100%;" rows="10">{{ old('description') }}</textarea>
                                    @error('description')
                                    <div class="text-warning">{{ $message }}</div>
                                    @enderror
                                </div>
