...
--
-- Host: localhost:3306
-- Generation Time: Sep 15, 2023 at 11:23 PM
...
CREATE TABLE `carriers` (
  ...
  `delevery_text` text COLLATE utf8mb4_unicode_ci,
  `logo` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `creator` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `slug` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` int NOT NULL DEFAULT '1',
...
(17, 38, 293, '2023-09-14 22:44:25', '2023-09-16 11:19:00'),
...
CREATE TABLE `comment_detail` (
  ...
  `type` tinyint DEFAULT '1' COMMENT '1 - text content\n2 - text file\n3 - audio\n4 - video\n5 - image',
  `created_time` datetime DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(133, 2, 293, 17, 'oke', NULL, 1, '2023-09-15 23:19:07');
...
CREATE TABLE `file_resources` (
  ...
  `pathfile` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type_file` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` int NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `products` (
  ...
  `expiration_date` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `minimum_amount` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `free_delivery` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `total_view` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(591, 293, 17, 1, '2023-09-15 23:19:07'),
(592, 1, 17, 1, '2023-09-15 23:19:07'),
(593, 75, 17, 1, '2023-09-15 23:19:07'),
(594, 224, 17, 1, '2023-09-15 23:19:07'),
(595, 274, 17, 1, '2023-09-15 23:19:07');
...
CREATE TABLE `vendors` (
  ...
  `description` text COLLATE utf8mb4_unicode_ci,
  `image` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `audio01` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `audio02` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `audio03` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `file01` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `file02` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `file03` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `video01` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `video02` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `video03` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` int NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
ALTER TABLE `course_lessons`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3106;
...
--
ALTER TABLE `vendor_users`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1388;
